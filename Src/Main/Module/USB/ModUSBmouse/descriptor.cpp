...
class USBdeviceDescriptor_0 : public USBdeviceDescriptor
{
  ...
  public:
                                       ...
                                       BYTE ID )
    {
      switch( getId( typeID, confID, interfID, ID ) )
      {
        ...
        case 0x5100: return( DataPointer( ( BYTE* )&descriptor[ 52], 47 ) ); // Report
        case 0x6000: return( DataPointer( ( BYTE* )&descriptor[ 99],  4 ) ); // String
        case 0x6001: return( DataPointer( ( BYTE* )&descriptor[103], 14 ) ); // String
        case 0x6002: return( DataPointer( ( BYTE* )&descriptor[117], 20 ) ); // String
        case 0x6003: return( DataPointer( ( BYTE* )&descriptor[137], 14 ) ); // String
        case 0x6004: return( DataPointer( ( BYTE* )&descriptor[151], 10 ) ); // String
        case 0x6005: return( DataPointer( ( BYTE* )&descriptor[161], 18 ) ); // String
      }
      return( DataPointer(  ) );
    }
  ...
  private:
    //---------------------------------------------------------------
    static const BYTE          descriptor[180];
...
//
//-------------------------------------------------------------------
const BYTE USBdeviceDescriptor_0::descriptor[180] =
{
  ...
  // DEVICE
    ...
    /* idProduct          */ (0x1000)&0xFF, (0x1000)>>8,
  ...
  // HID
    ...
    /* bCountryCode      */ HID::Country::GERMAN,
    /* bNumDescriptors   */ 1,
    /* bDescriptorType   */ 0x22,
    /* wDescriptorLength */ (47)&0xFF, (47)>>8,
  ...
  // REPORT
    ...
    /* Usage           */ 0x09, Report::UsagePage::GenericDesktop::MOUSE, 
    /* Collection      */ 0xA1, Report::Collection::PHYSICAL, 
    /* UsagePage       */ 0x05, Report::UsagePage::Button::PAGE_ID, 
    ...
    /* ReportCount     */ 0x95, 5, 
    /* ReportSize      */ 0x75, 1, 
    /* Input           */ 0x81, Report::DataType::VARIABLE, 
    /* ReportCount     */ 0x95, 3, 
    /* ReportSize      */ 0x75, 1, 
    /* Input           */ 0x81, Report::DataType::CONSTANT, 
    /* UsagePage       */ 0x05, Report::UsagePage::GenericDesktop::PAGE_ID, 
    /* Usage           */ 0x09, Report::UsagePage::GenericDesktop::X, 
    /* Usage           */ 0x09, Report::UsagePage::GenericDesktop::Y, 
    /* Usage           */ 0x09, Report::UsagePage::GenericDesktop::WHEEL, 
    /* LogicalMin      */ 0x15, (BYTE)-127, 
    /* LogicalMax      */ 0x25, (BYTE)127, 
    /* ReportSize      */ 0x75, 8, 
    /* ReportCount     */ 0x95, 3, 
    /* Input           */ 0x81, Report::DataType::VARIABLE | Report::DataType::RELATIVE, 
    /* EndCollection   */ 0xC0, 
